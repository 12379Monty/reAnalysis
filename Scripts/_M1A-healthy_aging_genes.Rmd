...
and because we can define healthy physiological status with ease [@Keller:2011aa].
...
AD diagnosis and selectivity over common age-related pathologies.
      - **<span style="color:blue">This is remarkably unexpected.</span>**
...
<p><p/>
* A given LLM model can display remarkable apparent intelligence and 
stunning stupidity
...
such as depth, breadth and source.
   - https://github.com/f/awesome-chatgpt-prompts

<p><p/>
In this report, we use a similarly constructed prompt to get chatGPT
to produce article reviews for three related arcicles
...
# 2015 Sood et. al. [@Sood:2015aa] {.taset}
