...
# General Remarks - Omic Scale Analysis {-}
...
interest, gene scores for example, may be obtained as a result of analyzing
features one at a time, the success of the design or analysis method
can only be assessed bu taking a holistic look at the study data and results.
...
# Preliminaries: Statistical Tests for Contingency Tables
...
or research assistants.  The articulation that these
tools produce is so impressive that it is easy to
z;ssssssssssssorget that they have no reasining power whatsoever.
