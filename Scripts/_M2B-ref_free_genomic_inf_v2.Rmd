...
<p><p>
* All RNA-Seq formal analyses entail QC, Pre-processing (normalization), followed by
the analysis steps that are the closest to the results, and often the only steps reported
on: feature identification/differential expression analysis, 
subgroup identification/cluster analysis.
   - similarly for other omic platforms.
   - the same should be done with these datasets
...
In the rest of the report we use various  GPT tools to produce literature reviews
...
##  RNA-Seq w/i Sample Rel Abundance 
...
# Part I - SPLASH and OASIS Studies  {-}
