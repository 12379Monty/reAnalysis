...
on each paper.   Each part is further separated into 
3  sections which review the relevant literature prior
to the papers, the papers themselves and the  relevant literature
following the publications of the SPLASH and OASIS papers.
...
# Reference-Free Genomic Inference {#soa-ref-free-genomics  .tabset}
...
## Lit Review - Prior SPLASH  {#ref-free-genomic-pre-splash  -}
...
# SPLASH  Citation Litetature {#splash-citings .tabset}
...
### chatGPT Prompt - Best Interact {-}

* Please list and compare the best GPT based research assistants to
answer specific questions about the content of a spcific paper
