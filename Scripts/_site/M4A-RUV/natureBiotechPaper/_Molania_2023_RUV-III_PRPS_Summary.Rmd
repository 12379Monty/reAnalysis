...
FN <- "_Molania_2023_RUV-III_PRPS_Summary"
if(sum(grepl(FN, list.files()))==0) stop("Check FN")

PREFIX <- "_Molania_2023_RUV-III_PRPS_Summary" #- replace by FLOWCELL???
...
This document summarizes in great detail the article by Molina
et al. (2023) in which it is shown that many TCGA datasets are
affected by unwanted variation which can affetct the resutsts
of an analysis.  It is also shown through numerous examples
how these effects can be removed.  Two case are shown in
Section \@ref(detail-res).


## Citation

```{r molania-2023-write-bib, results="asis", echo=F}
 # https://stackoverflow.com/questions/26851952/is-it-possible-to-insert-the-full-reference-of-an-article-in-the-middle-of-a-rma
  ...
  RUV_refs_lst <- bibtex::read.bib("../../../../_bibFiles/_RUV.bib")

 for(ID in c("Molania:2023aa")) {
  cat('\n* ')
  print(RUV_refs_lst[[ID]])
 }
...
# Detailed Results by Dataset {#detail-res}
...
<!-- To run
## nohup Rscript -e "knitr::knit2html('_Molania_2023_RUV-III_PRPS_Summary.Rmd')" > _Molania_2023_RUV-III_PRPS_Summary.log  &

## Or
## nohup Rscript -e "rmarkdown::render('_Molania_2023_RUV-III_PRPS_Summary.Rmd')" > _Molania_2023_RUV-III_PRPS_Summary.log  &
