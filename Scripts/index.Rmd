...
<p><p/>
* the analysis can be improved with the key to improvement being a
**valid assessment of performance** - Speed:
...
For the first two categories, documentation can be found in the published
literature.  The third category of delinquent analyses are typically not 
part of the published literature.

<br/>

## Clinical Validation Studies for a Complex Omic Diagnostic Instrument {-}

Some sources of errors in the clinical validation study analyses are:
...
<p><p/>
* there are many constraints which make the usual hypothesis testing or 
estimation paradigm untenable yet it is used ubiquitously
...
* [ai-assistant-guide](./ai-assistant-guide.html) - outline
