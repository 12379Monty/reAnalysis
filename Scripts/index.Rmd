...
null model and all results based on the analysis of the flawed data.
   - The statistic used to identify anchors with interesting variability
is analogous to a principal component of SVD, an approach often used to 
detect unwanted variability.
...
* [SPLASH & OASIS Follow-ups](M3B-SPLASH-OASIS/Datasets/SPLASH_followup_review.html)
