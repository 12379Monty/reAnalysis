...
Phil Stark (2022) [@Stark:2022aa] points out that although
the most famous quotation attributed to George Box is
...
<p><p/>
   - Apply RUV methodology to identify and remove unwanted variability
in the target count distributions.
<p><p/>
...
## Why are p-values so hard to swallow?
