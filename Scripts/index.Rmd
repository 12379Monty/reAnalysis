...
* As a reference which data analysts might go to, the articles lack the key peices needed
for the reader to get a true sense of performance and for the 
...
input data quality and not retricting ourselves to to Pearson’s X2
as comparator.
