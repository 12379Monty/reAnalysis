...
known sequence provides a powerful QC/QA element.  In the absence of this
element what supplemental QC/QA measures are included.
...
- **Statistical power<span style="color:green;">$^1$</span> through structure**:
...
- **Unified mathematical framework**<span style="color:green;">$^2$</span>:
  - *Contingency tables*<span style="color:green;">$^3$</span>
of anchor-target pairs
  - Same approach applies to viruses, human cells, non-model organisms

---

- <span style="color:green;">1</span>:  Statistical power, in the
technical sense of the word, needs to be demonstrated. Choosing
the chi-square test as comparator is unfortunate as it is not known
to be a particularly powerful test.  More respectable comparators can
be identified by surveying the RNA-Seq literature.

- <span style="color:green;">2</span>: I'm not sure that this
is a distinguishing feature of this approach as many RNA-Seq
methods can also make that claim.   In the end what we care about is
applications and performance.

- <span style="color:green;">3</span>: A contingency table is a way
...
not confer any analytical advantages other than providing a natural
...
- **Interpretation**: Measures deviation from independence model, *optimized for maximum statistical power*$^1$
...
## For Bioinformaticians: Technical Benefits <span style="color:green;">$^1$</span>
...
> <span style="color:green;">1</span>:  These benefits are neither
unique to SPLASH, nor necessary.
