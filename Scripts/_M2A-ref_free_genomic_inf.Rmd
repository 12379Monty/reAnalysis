...
bibliography: [../_bibFiles/_healthy_aging.bib, ../_bibFiles/_ref_free_genom_inf.bib, ../../_bibFiles/_Breiman.bib, ../../_bibFiles/_Yu.bib, ../../_bibFiles/_Freedman.bib]
...
<p><p/>
* In Section \@ref(splash-oasis-citing-review) we prompt blah blah blah to get
a review of the citing literature.
...
* The results in this section are most un-impressive.
   -0  Not sure how to make them better
)
...
# SPLASH - Chaung et al, 2023 [@Chaung:2023aa] {.tabset #splash-ai-review}
...
* Outside of simulated data, p-values cannot be taken at face value without
careful scrutiny of the data.  q-values even less so.

* p/q values may still provide useful guides for the purpose of ordering and
selecting features.  ie. designing filters
...
## OASIS -  Baharav et al., 2024 [@Baharav:2024aa] {#oasis-ai-review .tabset}
